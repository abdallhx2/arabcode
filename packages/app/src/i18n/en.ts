export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by arabcode",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in arabcode.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in arabcode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in arabcode.",
  ...
  "dialog.server.description": "Switch which arabcode server this app connects to.",
  ...
  "wsl.onboarding.checkingOpencode": "Checking arabcode...",
  "wsl.onboarding.checkingOpencodeIn": "Checking arabcode in {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Updating arabcode...",
  "wsl.onboarding.updatingOpencodeIn": "Updating arabcode in {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Update arabcode in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Update arabcode",
  "wsl.onboarding.opencodeReadyIn": "arabcode is ready in {{distro}}.",
  "wsl.onboarding.opencodeReady": "arabcode is ready.",
  "wsl.onboarding.installOpencodeIn": "Install arabcode in {{distro}}.",
  "wsl.onboarding.installOpencode": "Install arabcode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "arabcode not installed",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) is required before arabcode can add a WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL unavailable",
  "wsl.onboarding.wslUnavailable.description": "arabcode could not verify WSL on this machine.",
  "wsl.onboarding.installWsl": "Install WSL",
  "wsl.onboarding.windowsRestartRequired": "Restart Windows to finish installing WSL, then reopen arabcode.",
  ...
  "toast.update.description": "A new version of arabcode ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the arabcode team",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, arabcode does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "arabcode includes free models so you can start immediately.",
  ...
  "settings.desktop.wsl.description": "Run the arabcode server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Change the display language for arabcode",
  ...
  "settings.general.row.appearance.description": "Customise how arabcode looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether arabcode follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how arabcode is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when arabcode launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of arabcode.",
