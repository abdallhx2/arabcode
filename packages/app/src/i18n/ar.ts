export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "نماذج مجانية مقدمة من arabcode",
  ...
  "provider.connect.apiKey.description":
    "أدخل مفتاح واجهة برمجة تطبيقات {{provider}} الخاص بك لتوصيل حسابك واستخدام نماذج {{provider}} في arabcode.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " للحصول على رمز التفويض الخاص بك لتوصيل حسابك واستخدام نماذج {{provider}} في arabcode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " وأدخل الرمز أدناه لتوصيل حسابك واستخدام نماذج {{provider}} في arabcode.",
  ...
  "model.tooltip.provider": "المزوّد",
  ...
  "dialog.server.description": "تبديل خادم arabcode الذي يتصل به هذا التطبيق.",
  ...
  "toast.update.description": "نسخة جديدة من arabcode ({{version}}) متاحة الآن للتثبيت.",
  ...
  "error.page.report.prefix": "يرجى الإبلاغ عن هذا الخطأ لفريق arabcode",
  ...
  "error.chain.mcpFailed": 'فشل خادم MCP "{{name}}". لاحظ أن arabcode لا يدعم مصادقة MCP بعد.',
  ...
  "home.sessions.search.placeholder": "بحث في الجلسات",
  "home.sessions.search.placeholder.scoped": "بحث في الجلسات ضمن {{scope}}",
  "home.sessions.search.sessions": "الجلسات",
  "home.sessions.search.noResults": "لا توجد جلسات مطابقة لـ {{query}}",
  ...
  "session.child.promptDisabled": "لا يمكن إرسال طلبات لجلسات الوكلاء الفرعيين.",
  "session.child.backToParent": "العودة إلى الجلسة الرئيسية.",
  "session.error.notFound": "تعذر العثور على هذه الجلسة",
  "session.error.notFound.description": "تشير علامة التبويب هذه إلى جلسة لم تعد موجودة على هذا الخادم.",
  ...
  "session.review.noBranchChanges": "لا توجد تغييرات على الفرع بعد",
  ...
  "session.new.project.search": "بحث عن مشاريع",
  ...
  "sidebar.gettingStarted.line1": "يتضمن arabcode نماذج مجانية حتى تتمكن من البدء فورًا.",
  ...
  "app.name.desktop": "arabcode Desktop",
  ...
  "settings.desktop.wsl.description": "تشغيل خادم arabcode داخل WSL على Windows.",
  ...
  "wsl.onboarding.step.opencode": "arabcode",
  "wsl.onboarding.checkingRuntime": "جارٍ التحقق من WSL...",
  "wsl.onboarding.restartRequired": "يحتاج Windows إلى إعادة تشغيل لإكمال تثبيت WSL.",
  ...
  "wsl.onboarding.distroNotInstalled": "{{distro}} غير مثبتة بعد.",
  ...
  "wsl.onboarding.checkingOpencode": "جارٍ التحقق من arabcode...",
  "wsl.onboarding.checkingOpencodeIn": "جارٍ التحقق من arabcode في {{distro}}...",
  "wsl.onboarding.updatingOpencode": "جارٍ تحديث arabcode...",
  "wsl.onboarding.updatingOpencodeIn": "جارٍ تحديث arabcode في {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "تحديث arabcode في {{distro}}.",
  "wsl.onboarding.updateOpencode": "تحديث arabcode",
  "wsl.onboarding.opencodeReadyIn": "arabcode جاهز في {{distro}}.",
  "wsl.onboarding.opencodeReady": "arabcode جاهز.",
  "wsl.onboarding.installOpencodeIn": "تثبيت arabcode في {{distro}}.",
  "wsl.onboarding.installOpencode": "تثبيت arabcode",
  ...
  "wsl.onboarding.checkAgain": "التحقق مرة أخرى",
  "wsl.onboarding.distroStatus.ready": "جاهزة",
  "wsl.onboarding.distroStatus.checking": "جارٍ التحقق...",
  "wsl.onboarding.distroStatus.opencodeMissing": "arabcode غير مثبت",
  ...
  "wsl.onboarding.needAnotherDistro": "تحتاج توزيعة أخرى؟",
  "wsl.onboarding.needAnotherDistroHint": "ثبّت توزيعة لينكس من كتالوج WSL",
  "wsl.onboarding.wslNotInstalled.title": "WSL غير مثبت",
  "wsl.onboarding.wslNotInstalled.description": "يلزم تثبيت WSL (نظام Windows الفرعي لِلينكس) قبل أن يتمكن arabcode من إضافة خادم WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL غير متاح",
  "wsl.onboarding.wslUnavailable.description": "تعذر على arabcode التحقق من WSL على هذا الجهاز.",
  "wsl.onboarding.installWsl": "تثبيت WSL",
  "wsl.onboarding.windowsRestartRequired": "أعد تشغيل Windows لإنهاء تثبيت WSL، ثم أعد فتح arabcode.",
  "wsl.onboarding.next": "التالي",
  "wsl.onboarding.refresh": "تحديث",
  "wsl.onboarding.allDistrosAdded": "كل التوزيعات المثبتة مُضافة بالفعل.",
  ...
  "wsl.onboarding.searchDistros": "بحث عن توزيعات",
  ...
  "settings.general.row.shell.title": "غلاف الأوامر",
  "settings.general.row.shell.description": "اختر الغلاف المستخدم لمحطتك الطرفية. تُستخدم الأغلفة المتوافقة أيضًا في استدعاءات أدوات الوكيل.",
  ...
  "settings.general.row.language.description": "تغيير لغة العرض لـ arabcode",
  "settings.general.row.appearance.title": "المظهر",
  "settings.general.row.appearance.description": "تخصيص كيفية ظهور arabcode على جهازك",
  "settings.general.row.colorScheme.title": "مخطط الألوان",
  "settings.general.row.colorScheme.description": "اختر ما إذا كان arabcode يتبع سمة النظام أو الفاتح أو الداكن",
  "settings.general.row.theme.title": "السمة",
  "settings.general.row.theme.description": "تخصيص سمة arabcode.",
  ...
  "settings.general.row.mobileTitlebarBottom.description": "وضع شريط العنوان وعلامات تبويب الجلسات في أسفل الشاشة على الأجهزة المحمولة",
  "settings.general.row.showCustomAgents.title": "الوكلاء المخصصون",
  "settings.general.row.showCustomAgents.description": "إظهار منتقي الوكلاء في مربع الكتابة",
  "settings.general.row.newLayoutDesigns.title": "التصميم والمخطط الجديد",
  "settings.general.row.newLayoutDesigns.description": "تفعيل المخطط الجديد وواجهات الرئيسية ومربع الكتابة والجلسة المُعاد تصميمها",
  ...
  "settings.updates.row.startup.description": "التحقق تلقائيًا من التحديثات عند تشغيل arabcode",
  ...
  "settings.updates.toast.latest.description": "أنت تستخدم أحدث إصدار من arabcode.",
  ...
  "session.question.pending.one": "{{count}} سؤال معلّق",
  "session.question.pending.other": "{{count}} أسئلة معلّقة",
