...
import type { Data, Definition, Payload } from "@arabcode/schema/event"
...
import { Durable } from "@arabcode/schema/durable-event-manifest"

export const ID = Event.ID
export type ID = import("@arabcode/schema/event").ID
export type { Data, Definition, Payload } from "@arabcode/schema/event"
