...
} from "@arabcode/plugin/tui"
import { AttentionSoundName, type TuiConfig } from "./config"
import { Schema } from "effect"
import stripAnsi from "strip-ansi"
import * as TuiAudio from "./audio"
import defaultSoundPath from "@arabcode/ui/audio/bip-bop-01.mp3" with { type: "file" }
import questionSoundPath from "@arabcode/ui/audio/bip-bop-03.mp3" with { type: "file" }
import permissionSoundPath from "@arabcode/ui/audio/staplebops-06.mp3" with { type: "file" }
import errorSoundPath from "@arabcode/ui/audio/nope-03.mp3" with { type: "file" }
import doneSoundPath from "@arabcode/ui/audio/bip-bop-01.mp3" with { type: "file" }
import subagentDoneSoundPath from "@arabcode/ui/audio/yup-01.mp3" with { type: "file" }
