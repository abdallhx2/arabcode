...
> current private `@arabcode/llm` API. Names and exact TypeScript signatures
> are illustrative until implementation, but the domain boundaries and defaults
> are deliberate.

## Status

- Proposed package: `@arabcode/ai`
...
import { LLM } from "@arabcode/ai"
import { OpenAI } from "@arabcode/ai/providers/openai"
...
```ts
import { Message } from "@arabcode/ai"
...
import { LLM, Tool } from "@arabcode/ai"
...
```ts
import { LLM } from "@arabcode/ai/promise"
import { OpenAI } from "@arabcode/ai/providers/openai"
...
```ts
import { LLMSchema } from "@arabcode/ai/schema"
...
```ts
import { Provider, Protocol } from "@arabcode/ai/provider"
...
@arabcode/ai/provider
  experimental Provider and Protocol authoring APIs

@arabcode/ai/providers/openai
@arabcode/ai/providers/anthropic
@arabcode/ai/providers/google
...
```
