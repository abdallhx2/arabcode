...
import { compile, emitEffectImported, emitPromise, write } from "@arabcode/httpapi-codegen"
        ...
        emitPromise(contract, {
          outputTypes: {
            "events.subscribe": {
              ...
              import: 'import type { OpenCodeEventEncoded } from "@arabcode/protocol/groups/event"',
            },
          },
        }),
