...
import { SkillPlugin } from "@arabcode/core/plugin/skill"
import { Permission } from "@/permission"
import { FSUtil } from "@arabcode/core/fs-util"
import { Config } from "@/config/config"
import { FrontmatterError } from "@arabcode/core/v1/config/error"
import { ConfigMarkdown } from "@/config/markdown"
import { RuntimeFlags } from "@/effect/runtime-flags"
import { Glob } from "@arabcode/core/util/glob"
...
const CUSTOMIZE_OPENCODE_SKILL_NAME = "customize-arabcode"
const CUSTOMIZE_OPENCODE_SKILL_DESCRIPTION =
  "Use ONLY when the user is editing or creating arabcode's own configuration: opencode.json, opencode.jsonc, files under .opencode/, or files under ~/.config/arabcode/. Also use when creating or fixing arabcode agents, subagents, skills, plugins, MCP servers, or permission rules. Do not use for the user's own application code, or for any project that is not configuring arabcode itself."
