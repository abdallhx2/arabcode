...
import { llmClient } from "@arabcode/core/effect/app-node-platform"
...
import type { LLMEvent } from "@arabcode/llm"
import { LLMClient } from "@arabcode/llm/route"
import type { LLMClientService } from "@arabcode/llm/route"
...
> = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const run = Effect.fn("LLM.run")(function* (input: StreamRequest) {
      ...
      // Runtime seam: native is an opt-in adapter over @arabcode/llm. It
