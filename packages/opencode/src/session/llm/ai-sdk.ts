import { FinishReason, LLMEvent, ProviderMetadata, ToolResultValue } from "@arabcode/llm"
...
// Move this extraction into @arabcode/llm when Copilot is handled by the native runtime.
