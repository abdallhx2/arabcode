import type { JsonSchema, LLMRequest, ProviderMetadata } from "@arabcode/llm"
import { LLM, Message, SystemPart, ToolCallPart, ToolDefinition, ToolResultPart } from "@arabcode/llm"
import {
  AmazonBedrock,
  Anthropic,
  Azure,
...
export const request = (input: RequestInput) => {
  ...
  // @arabcode/llm request objects from opencode's session/AI SDK-shaped data.
  return LLM.request({
