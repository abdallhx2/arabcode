...
export const PluginCommand = effectCmd({
  ...
  aliases: ["plug"],
  describe: "تثبيت إضافة وتحديث الإعدادات",
  builder: (yargs) =>
    yargs
      .positional("module", {
        type: "string",
        describe: "اسم وحدة npm",
      })
      .option("global", {
        alias: ["g"],
        type: "boolean",
        default: false,
        describe: "التثبيت في الإعدادات العامة",
      })
      .option("force", {
        alias: ["f"],
        type: "boolean",
        default: false,
        describe: "استبدال نسخة الإضافة الحالية",
      }),
