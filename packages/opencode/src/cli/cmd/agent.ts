...
const AgentCreateCommand = effectCmd({
  command: "create",
  describe: "إنشاء وكيل جديد",
  builder: (yargs: Argv) =>
    yargs
      .option("path", {
        type: "string",
        describe: "مسار المجلد لإنشاء ملف الوكيل",
      })
      .option("description", {
        type: "string",
        describe: "ما الذي يجب أن يفعله الوكيل",
      })
      .option("mode", {
        type: "string",
        describe: "وضع الوكيل",
...
const AgentListCommand = effectCmd({
  command: "list",
  describe: "عرض كل الوكلاء المتاحين",
