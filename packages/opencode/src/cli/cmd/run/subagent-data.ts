import type { Event, Message, Part, PermissionRequest, QuestionRequest, ToolPart } from "@arabcode/sdk/v2"
...
function ensureBlockerTab(
  ...
  if (current) {
    ...
    const next = {
      ...current,
      description: kind === "permission" ? "إذن قيد الانتظار" : "سؤال قيد الانتظار",
