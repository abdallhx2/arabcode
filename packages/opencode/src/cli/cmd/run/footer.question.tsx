...
import type { QuestionRequest } from "@arabcode/sdk/v2"
import {
      ...
      >
        <Show when={!single()}>
          <box flexDirection="row" gap={1} paddingLeft={1} flexShrink={0}>
            ...
            >
              <text fg={confirm() ? props.theme.surface : props.theme.muted}>تأكيد</text>
            </box>
          </box>
        </Show>
            ...
            <box width="100%" flexGrow={1} flexShrink={1} paddingLeft={1}>
              ...
              >
                <box width="100%" flexDirection="column" gap={1}>
                  <box paddingLeft={1}>
                    <text fg={props.theme.text}>مراجعة</text>
                  </box>
                  <For each={props.request.questions}>
                    {(item, index) => {
          ...
          <box width="100%" flexGrow={1} flexShrink={1} paddingLeft={1} gap={1}>
            <box>
              <text fg={props.theme.text} wrapMode="word">
                {info()?.question}
                {info()?.multiple ? " (اختر كل ما ينطبق)" : ""}
              </text>
            </box>
        ...
        >
          ...
          >
              ...
              fallback={
                <>
                  <text fg={props.theme.text}>
                    enter <span style={{ fg: props.theme.muted }}>حفظ</span>
                  </text>
                  <text fg={props.theme.text}>
            ...
            >
              ...
              <text fg={props.theme.text}>
                esc <span style={{ fg: props.theme.muted }}>تجاهل</span>
              </text>
            </Show>
          </box>
        </Show>
