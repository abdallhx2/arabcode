...
export function RejectField(props: {
  ...
  return (
    <textarea
      ...
      maxHeight={3}
      wrapMode="word"
      placeholder="أخبر arabcode بما تريده أن يفعله بشكل مختلف"
      ...
      >
        ...
        <Switch>
          ...
          <Match when={state().stage === "reject"}>
            <box paddingLeft={1}>
              <text fg={props.theme.muted}>أخبر arabcode بما تريده أن يفعله بشكل مختلف</text>
            </box>
          </Match>
        </Switch>
      </box>
              ...
              <Show
                ...
                fallback={
                  <text fg={props.theme.muted} wrapMode="word" flexShrink={0}>
                    جارٍ انتظار حدث الإذن...
                  </text>
                }
              >
                <box flexDirection="row" gap={2} flexShrink={0}>
                  <text fg={props.theme.text}>
                    enter <span style={{ fg: props.theme.muted }}>تأكيد</span>
                  </text>
                  <text fg={props.theme.text}>
                    esc <span style={{ fg: props.theme.muted }}>إلغاء</span>
                  </text>
                </box>
              </Show>
            </box>
      ...
      >
              ...
              >
                <box width="100%" flexDirection="column" gap={1}>
                  ...
                  <Show when={!info().diff && info().lines.length === 0}>
                    <box paddingLeft={1}>
                      <text fg={props.theme.muted}>لا توجد تغييرات</text>
                    </box>
                  </Show>
                </box>
              </scrollbox>
        ...
        >
          ...
          >
            <box flexDirection="row" gap={2} flexShrink={0}>
              <text fg={props.theme.text}>
                {"⇆"} <span style={{ fg: props.theme.muted }}>اختيار</span>
              </text>
              <text fg={props.theme.text}>
                enter <span style={{ fg: props.theme.muted }}>تأكيد</span>
              </text>
              <text fg={props.theme.text}>
                esc <span style={{ fg: props.theme.muted }}>{state().stage === "always" ? "إلغاء" : "رفض"}</span>
              </text>
            </box>
          </Show>
        </box>
