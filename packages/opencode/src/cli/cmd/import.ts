import type { Session as SDKSession, Message, Part } from "@arabcode/sdk/v2"
...
import { SessionTable, MessageTable, PartTable } from "@arabcode/core/session/sql"
...
export const ImportCommand = effectCmd({
  command: "import <file>",
  describe: "استيراد بيانات الجلسة من ملف JSON أو رابط",
  builder: (yargs) =>
    yargs.positional("file", {
      describe: "مسار ملف JSON أو رابط المشاركة",
      type: "string",
      demandOption: true,
    }),
