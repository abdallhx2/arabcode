...
export const TypeId: TypeId = "~@arabcode/effect-sqlite-node/NodeSqliteClient"
export type TypeId = "~@arabcode/effect-sqlite-node/NodeSqliteClient"
...
export const SqliteClient = Context.Service<SqliteClient>("@arabcode/effect-sqlite-node/NodeSqliteClient")
