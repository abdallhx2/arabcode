...
- Effect plugins import `@arabcode/plugin/v2/effect`, not `@arabcode/core`.
- Public domain values use generated `@arabcode/sdk` types.
...
- Define `PluginHost` domain capabilities in `@arabcode/plugin/v2/effect`.
