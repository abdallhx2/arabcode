import { OpenCode } from "@arabcode/client/effect"
...
import { createEmbeddedRoutes } from "@arabcode/server/routes"
...
export class Service extends Context.Service<Service, Interface>()("@arabcode/sdk-next/OpenCode") {}
